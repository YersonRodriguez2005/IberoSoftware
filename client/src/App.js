      ...
      <div className="datos">
        ...
        <label>
          ...
          <input
            ...
            placeholder="Escribe aqui un nombre, ejemplo: Pepito Perez"
            onChange={(e) =>
        ...
        <label>
          ...
          <input
            ...
            placeholder="Escribe aqui la edad, ejemplo: 25"
            onChange={(e) =>
        ...
        <label>
          ...
          <input
            ...
            placeholder="Escribe aqui un pais, ejemplo: Mexico"
        ...
        <label>
          ...
          <input
            ...
            placeholder="Escribe aqui un cargo, ejemplo: Desarrollador"
        ...
        <label>
          ...
          <input
            ...
            placeholder="Escribe aqui los años de experiencia, ejemplo: 3"
            onChange={(e) =>
        ...
        <div className="tabla-container">
          ...
          <table className="tabla-registros">
            ...
            <tbody>
              {/* Cuerpo de la tabla */}
              {registros.map(
                (reg, idx /* Recorremos cada registro con su índice */) => (
                  <tr key={idx}>
